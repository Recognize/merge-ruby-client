...
module Merge
  module Integrations
    class AccountIntegration
      ...
      # @return [Array<Merge::Integrations::CategoriesEnum>] Category or categories this integration belongs to. Multiple categories should
      #  be comma separated, i.e. [ats, integrations].
      ...
      #  <i>Workforce Now (in lieu of ADP Workforce Now), SuccessFactors (in lieu of SAP
      #  SuccessFactors)</i>
      # @param categories [Array<Merge::Integrations::CategoriesEnum>] Category or categories this integration belongs to. Multiple categories should
      #  be comma separated, i.e. [ats, integrations].
      ...
      # @return [Merge::Integrations::AccountIntegration]
      ...
      # @return [Merge::Integrtions::AccountIntegration]
